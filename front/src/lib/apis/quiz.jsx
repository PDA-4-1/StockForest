...
const SHINHAN_URL = "https://openapi.koreainvestment.com:9443";
const service = axios.create({ withCredentials: true, baseURL: BASE_URL });
const shinhanService = axios.create({ baseURL: SHINHAN_URL });

const realName = ["005930", "035720", "041510",   //삼성전자 카카오 SM
"005380", "068270", "006360",               //현대차 셀트리온 GS건설
"090430", "008770", "051910"];              //아모레퍼시픽 신라호텔 LG화학
    ...
    const res = await shinhanService.get(
        "/uapi/domestic-stock/v1/quotations/inquire-daily-itemchartprice",
        {
            headers: {
                ...
                appsecret: import.meta.env.VITE_secretKey,
